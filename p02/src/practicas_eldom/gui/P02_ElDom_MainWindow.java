...
public class P02_ElDom_MainWindow {
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		String[] opciones = {"Pulsadores", "Interruptores", "Conmutador"};
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int leido = comboBox.getSelectedIndex();
				System.out.println("Se seleccionó " + leido + " del JComboBox");
				
				if (leido == 0) commSerie.WriteString("#1");
				else if (leido == 1)  commSerie.WriteString("#2");
				else  commSerie.WriteString("#3");;
			}
		});
