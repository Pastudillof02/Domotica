...
class ModbusSlave {
	...
	public:
		...
		int read_holding_registers(unsigned char function, unsigned int start_addr, unsigned char reg_count, uint16_t *regs);
		...
		void set_BankInputAnalogRegister(uint16_t *Regs, uint16_t lengthRegs);
	};
